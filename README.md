...
**Версия 1.1.1** - Плагин для Obsidian, который обеспечивает **двустороннюю синхронизацию** с удаленным хранилищем swiftStorm через безопасное Telegram-подтверждение.
